class ApplicationController < ActionController::Base
  ...
  def load_home_bikes
    @home_bikes = [
      ...
      {bike_url: '/framesets/limited-edition-bettini-vxrs', bike_image: 'Bettini-frame.png', bike_logo: 'VXRS-LOGO-black.png', bike_headline: 'Bettini Limited Edition VXrs', bike_bg: 'home-bike-bettini-bg.png'}
